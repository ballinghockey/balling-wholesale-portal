...
export default async function AdminPage() {
  ...
  const { data: allOrders } = await admin
    .from('order_requests')
    .select(`order_id, order_date, currency, net_total, grand_total, status, customer_id, shipping_address, loyalty_credit_applied, order_lines (id, sku, product_name, size, qty, list_price, customer_discount_pct, promo_discount_pct, final_unit_price, line_total)`)
